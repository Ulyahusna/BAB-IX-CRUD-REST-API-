...
from restflask.app import response
from restflask import app
...
class UserController:
    ...
    def store():
        try:
            ...
            return response.ok('', 'Succesfully Create Data!')
    ...
    def update(id):
        try:
            ...
            db.session.commit()
            return response.ok('', 'Succesfully Update Data!')
